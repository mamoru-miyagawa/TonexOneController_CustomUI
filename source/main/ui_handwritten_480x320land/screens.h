...
typedef struct _objects_t {
    ...
    /* Chip frame containers for the 480x320 main-screen chain band (handwritten).
       ui_icon_X stays as the lv_img (kept for lv_img_set_src compatibility);
       ui_chip_X is the new clickable styled container that holds it. */
